...
Additionally, the application can also be run locally by following these instructions:
    ...
    - The back-end component can be started by executing the `app.py` file, with the root directory located at the `page-rhythm/src/BackEnd/PageRhythm` path.
    ...
    - The front-end component can be started by running the command `npm run build` from the root directory located at `pagerhythm/src/FrontEnd/PageRhythm`.
